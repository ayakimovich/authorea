...
We have next compared the execution times of our model image analysis program identical to "janus.m" and "janus.jl". Median results of 1000 iterations in the test environment mentioned above suggested that MATLAB\textsuperscript{TM} R2014a performed XX folds of Julia 3.10 and R2015a YY folds of Julia 3.10. We concluded that performance of Julia and MATLAB\textsuperscript{TM} was comparable for this specific case. This may be caused by the fact that MATLAB\textsuperscript{TM} is highly optimized for vector operations used in this program.
