...
\begin{table} 
    \begin{tabular}{cccc}
    \hline
        \textbf{Algorithm} & \textbf{Reported 2014a}\footnote{MATLAB\textsuperscript{TM} Folds Julia 0.3.7} & \textbf{Tested  2014a} \footnote{MATLAB\textsuperscript{TM} Folds Julia 0.3.10} & \textbf{Tested 2015a}\footnote{MATLAB\textsuperscript{TM} Folds Julia 0.3.10} \\
        \hline
