...
\begin{table} 
    \begin{tabular}{cccc}
    \hline
        \textbf{Algorithm} & \textbf{Reported\cr MATLAB\textsuperscript{TM} 2014a\cr (Folds Julia 0.3.7)} & \textbf{Tested\cr MATLAB\textsuperscript{TM} 2014a\cr (Folds Julia 0.3.10)} & \textbf{Tested\cr MATLAB 2015a\cr (Folds Julia 0.3.10)} \\
        \hline
