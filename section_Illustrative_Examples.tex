...
\begin{table} 
    ...
    \hline
        ...
        \multicolumn{4}{c}{\textsuperscript{1}MATLAB\textsuperscript{TM} Folds Julia 0.3.7} \\
        \multicolumn{4}{c}{\textsuperscript{2}MATLAB\textsuperscript{TM} Folds Julia 0.3.10} \\
    \end{tabular}
\end{table}
